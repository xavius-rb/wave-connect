  ...
  def create
    ...
    respond_to do |format|
      if @stage_environment.save
        format.html { redirect_to stage_environment_url(@stage_environment), notice: "Stage environment was successfully created." }
  ...
  def update
    respond_to do |format|
      if @stage_environment.update(stage_environment_params)
        format.html { redirect_to stage_environment_url(@stage_environment), notice: "Stage environment was successfully updated." }
